				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><a href="/DAYCOST/index.php/Home/User/xzmon">添加页面</a></li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12" style="">
								<div class="col col-md-5" style="height:200px; background: #FFF;">
               					</br>
                				<form class="form-signin" method="post"   action='/DAYCOST/index.php/Home/User/doxzmon' name="myForm">
                   
                    
                    <input type="text" maxlength="20" class="form-control" placeholder="添加金钱额度" name="Money" required autofocus></br>
                    
                    
                    <input type="date"  class="form-control" placeholder="时间" name="Time" required></br>
                    <input type="text" maxlength="50" class="form-control" placeholder="备注" name="Remarks" required></br>
                    ...
                    <script type="text/javascript">
                    	$("#submit").click(function(){
					        ...
					        $.ajax({
					                url:"/DAYCOST/index.php/Home/User/doxzmon",
					                data:{Mone:Money,Time:Time,Remarks:Remarks},
					                dataType:"TEXT",
					                type:"POST",
