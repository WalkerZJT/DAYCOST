				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><a href="/DAYCOST/index.php/Home/User/xjmon">支出页面</a></li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12" style="">
                				...
                				<form class="form-signin" method="post"   action='/DAYCOST/index.php/Home/User/doxjmon' name="myForm">
                    ...
                    <script type="text/javascript">
                    	$("#submit").click(function(){
					        ...
					        $.ajax({
					                url:"/DAYCOST/index.php/Home/User/doxjmon",
