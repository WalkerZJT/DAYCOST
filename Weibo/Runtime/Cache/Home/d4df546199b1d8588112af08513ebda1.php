						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-xs-4" style="height:400px;background: #F9F9F9">
									<h3 >剩余金额:<?php echo ($data3); ?></h3>
									<h3>总收入（蓝色）:<?php echo ($data1); ?></h3>
									<h4>总收入所占比:<?php echo ($data4); ?>%</h4>
									<h3>总支出（灰色）:<?php echo ($data2); ?></h3>
									<h4>总收入所占比:<?php echo ($data5); ?>%</h4>
									<ul class="list-group" style="font-size: 16px;">
										<li class="list-group-item"><a href="/DAYCOST/index.php/Home/User/xall">按年份月份详细信息</a></li>
										<li class="list-group-item"><a href="/DAYCOST/index.php/Home/User/xsall">详细收入信息</a></li>
										<li class="list-group-item"><a href="/DAYCOST/index.php/Home/User/xzall">详细支出信息</a></li>
