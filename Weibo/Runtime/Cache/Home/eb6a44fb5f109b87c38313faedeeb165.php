										...
										<div class="space-12"></div>
											...
											<?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo ($vo["UserID"]); ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about"><?php echo ($vo["phone"]); ?></span>
													</div>
												</div>
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about"><?php echo ($vo["email"]); ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about"><?php echo ($vo["motto"]); ?></span>
													</div>
												</div>
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="country"><?php echo ($vo["pro"]); ?></span>
														<span class="editable" id="city"><?php echo ($vo["city"]); ?></span>
											...
											<div class="center">
												<a href="/DAYCOST/index.php/Home/User/personal" class="btn btn-sm btn-primary">
